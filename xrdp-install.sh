...
mkdir -p ~/.config/i3/
# the following configuration has two alterations: gnome-terminal is the default terminal and some quotes are changed near the bottom (to work in this script)
