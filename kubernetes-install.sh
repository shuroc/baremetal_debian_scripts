...
echo "Make sure you have docker installed..." && sleep 3
printf '{
...
printf "deb https://apt.kubernetes.io/ kubernetes-xenial main" | sudo tee /etc/apt/sources.list.d/kubernetes.list
sudo apt-get update
